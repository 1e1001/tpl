...
{define-syntax (-module-begin stx)
  {parameterize ([current-namespace (make-base-namespace)])
    ...
    {for/list ([expr exprs])
      (if {let/cc brk
            ; FIXME: this doesn't actually expand properly - sad!
            ; also should probably recurse through #%begin's
...
(provide ~parameterize)
{define-syntax-rule (~parameterize vars . body)
  {parameterize vars
    (~ . body)}}
